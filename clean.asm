...
collisionSound db "brick_collision.wav", 0
game_start db "game_start.wav", 0
...
initialize_game PROC
    INVOKE PlaySound, ADDR game_start, NULL, 0
    call display_heart
...
CheckBrickCollision PROC
    ...
    cmp ball_x, cl
    jg nocollision
    INVOKE PlaySound, ADDR collisionSound, NULL, 0
    MOV ecx, 1
    ret
    nocollision:
    MOV ecx, 0
